...
Exp:
    ...
    /* | Exp ASSIGNO
    P error    {ERR("fool expression");}
    | Exp AN
    D error         {ERR("fool expression");}
    | Exp O
    R error          {ERR("fool expression");}
    | Exp RELO
    P error       {ERR("fool expression");}
    | Exp PLU
    S error        {ERR("fool expression");}
    | Exp MINU
    S error       {ERR("fool expression");}
    | Exp STA
    R error        {ERR("fool expression");}
    | Exp DI
    V error         {ERR("fool expression");}
    | L
    P error RP           {ERR("fool expression");}
    | MINU
    S error           {ERR("fool expression");}
    | NO
    T error             {ERR("fool expression");}
    | ID L
    P error RP        {ERR("fool expression");}
    | ID L
    P error SEMI      {ERR("fool you");}
    | Exp L
    B error RB       {ERR("fool shit");}
    | Exp L
    B error SEMI     {ERR("dog shit");} */
Args: Exp COMMA Args {
